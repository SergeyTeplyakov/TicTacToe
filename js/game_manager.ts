...
class GameManager {
    ...
    someoneWin() : string {
        let diag1 = [this.grid.cells[0][0], this.grid.cells[1][1], this.grid.cells[2][2]];
        let diag2 = [this.grid.cells[2][0], this.grid.cells[1][1], this.grid.cells[0][2]];
        ...
        {
            let row = [this.grid.cells[n][0], this.grid.cells[n][1], this.grid.cells[n][2]];
            let col = [this.grid.cells[0][n], this.grid.cells[1][n], this.grid.cells[2][n]];
    ...
    areTheSame(array: Tile[]) : string {
        if (this.all(array, t => t.value === 'X')) {
            return 'X';
        }
        if (this.all(array, t => t.value === 'O')) {
            return 'O';
        }
        return undefined;
    }
    
    all(array: Tile[], predicate: (tile: Tile) => boolean) : boolean {
        for(let t of array) {
